---
description: You can change the ZAP port number by opening ZAP tools, going to options, and selecting local proxy. Learn how to change the default ZAP port with our quick ZAP guide.
