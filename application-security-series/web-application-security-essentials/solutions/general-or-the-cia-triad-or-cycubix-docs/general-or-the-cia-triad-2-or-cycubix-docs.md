---
title: "General | The CIA Triad (2) | Cycubix Docs"
layout: default
nav_order: 2
...
#### Examples that compromise confidentiality: <a href="#examples_that_compromise_confidentiality" id="examples_that_compromise_confidentiality"></a>
...
#### Examples of methods ensuring confidentiality <a href="#examples_of_methods_ensuring_confidentiality" id="examples_of_methods_ensuring_confidentiality"></a>
