...
One example why this protection is not enough can be found [here](https://bugs.chromium.org/p/chromium/issues/detail?id=490015). Turns out `Navigator.sendBeacon()` was allowed to send POST request with an arbitrary content-type.
