---
description: >-
  As part of our Web Application Security Essentials course we offer practical
  guides on HTTPS proxy. Learn HTTPS proxy basics with our security essentials
  guide.
---
